...
namespace Zmei
{
    ...
    class Program
    {
        ...
        public static Zmei snake;
        public enum move { up, down, left, right, stop }
        public static move dir = move.stop;
        public static int futX = 0, futY = 0;
        public static void Init()
        {
            snake = new Zmei() { HeadX = width / 2, HeadY = height / 2, parts = new List<Zmei.Part>() { new Zmei.Part() { x = (width / 2) - 1, y = height / 2, oldx = (width / 2) - 1, oldy = height / 2 } } };
        ...
        public static void Logic()
        {
            ...
            if (dir != move.stop)
            {
                ...
                {
                    snake.parts.Add(new Zmei.Part() { x = snake.parts[snake.parts.Count - 1].oldx, y = snake.parts[snake.parts.Count - 1].oldy });
                    SetFruit();
                }
            }
        }
